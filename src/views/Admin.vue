<template>
  ...
  async function uploadLogo(event) {
    ...
    const res = await axios.post("https://vue-shop-u098.onrender.com/api/upload/logo", formData, {
  ...
  async function uploadProductImage(id, event) {
    ...
    const res = await axios.post(`https://vue-shop-u098.onrender.com/api/upload/product/${id}`, formData, {
      headers: { "Content-Type": "multipart/form-data" },
    });
